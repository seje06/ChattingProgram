...
bool DBConnection::BindParam(int32_t paramIndex, bool* value, SQLLEN* index)
{
	return BindParam(paramIndex, SQL_C_TINYINT, SQL_TINYINT, sizeof(bool), value, index);
}

bool DBConnection::BindParam(int32_t paramIndex, float* value, SQLLEN* index)
{
	return BindParam(paramIndex, SQL_C_FLOAT, SQL_REAL, 0, value, index);
}

bool DBConnection::BindParam(int32_t paramIndex, double* value, SQLLEN* index)
{
	return BindParam(paramIndex, SQL_C_DOUBLE, SQL_DOUBLE, 0, value, index);
}

bool DBConnection::BindParam(int32_t paramIndex, int8_t* value, SQLLEN* index)
{
	return BindParam(paramIndex, SQL_C_TINYINT, SQL_TINYINT, sizeof(int8_t), value, index);
}

bool DBConnection::BindParam(int32_t paramIndex, int16_t* value, SQLLEN* index)
{
	return BindParam(paramIndex, SQL_C_SHORT, SQL_SMALLINT, sizeof(int16_t), value, index);
}

bool DBConnection::BindParam(int32_t paramIndex, int32_t* value, SQLLEN* index)
{
	return BindParam(paramIndex, SQL_C_LONG, SQL_INTEGER, sizeof(int32_t), value, index);
}

bool DBConnection::BindParam(int32_t paramIndex, int64_t* value, SQLLEN* index)
{
	return BindParam(paramIndex, SQL_C_SBIGINT, SQL_BIGINT, sizeof(int64_t), value, index);
}

bool DBConnection::BindParam(int32_t paramIndex, TIMESTAMP_STRUCT* value, SQLLEN* index)
{
...
bool DBConnection::BindParam(int32_t paramIndex, const BYTE* bin, int32_t size, SQLLEN* index)
{
	if (bin == nullptr)
	{
		*index = SQL_NULL_DATA;
...
bool DBConnection::BindCol(int32_t columnIndex, bool* value, SQLLEN* index)
{
	return BindCol(columnIndex, SQL_C_TINYINT, sizeof(bool), value, index);
}

bool DBConnection::BindCol(int32_t columnIndex, float* value, SQLLEN* index)
{
	return BindCol(columnIndex, SQL_C_FLOAT, sizeof(float), value, index);
}

bool DBConnection::BindCol(int32_t columnIndex, double* value, SQLLEN* index)
{
	return BindCol(columnIndex, SQL_C_DOUBLE, sizeof(double), value, index);
}

bool DBConnection::BindCol(int32_t columnIndex, int8_t* value, SQLLEN* index)
{
	return BindCol(columnIndex, SQL_C_TINYINT, sizeof(int8_t), value, index);
}

bool DBConnection::BindCol(int32_t columnIndex, int16_t* value, SQLLEN* index)
{
	return BindCol(columnIndex, SQL_C_SHORT, sizeof(int16_t), value, index);
}

bool DBConnection::BindCol(int32_t columnIndex, int32_t* value, SQLLEN* index)
{
	return BindCol(columnIndex, SQL_C_LONG, sizeof(int32_t), value, index);
}

bool DBConnection::BindCol(int32_t columnIndex, int64_t* value, SQLLEN* index)
{
	return BindCol(columnIndex, SQL_C_SBIGINT, sizeof(int64_t), value, index);
}

bool DBConnection::BindCol(int32_t columnIndex, TIMESTAMP_STRUCT* value, SQLLEN* index)
{
	return BindCol(columnIndex, SQL_C_TYPE_TIMESTAMP, sizeof(TIMESTAMP_STRUCT), value, index);
}

bool DBConnection::BindCol(int32_t columnIndex, WCHAR* str, int32_t size, SQLLEN* index)
{
	return BindCol(columnIndex, SQL_C_WCHAR, size, str, index);
}

bool DBConnection::BindCol(int32_t columnIndex, BYTE* bin, int32_t size, SQLLEN* index)
{
